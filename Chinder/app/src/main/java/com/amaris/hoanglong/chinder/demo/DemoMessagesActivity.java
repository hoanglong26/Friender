...
public abstract class DemoMessagesActivity extends AppCompatActivity
    ...
    public static int TOTAL_MESSAGES_COUNT = 100;
...
//        messagesAdapter.addToStart(MessagesFixtures.getTextMessage(), true);
    ...
    protected void loadMessages(final boolean isMe) {
        new Handler().postDelayed(new Runnable() { //imitation of internet connection
            @Override
            public void run() {
                ArrayList<Message> messages = MessagesFixtures.getMessages(lastLoadedDate, isMe);
