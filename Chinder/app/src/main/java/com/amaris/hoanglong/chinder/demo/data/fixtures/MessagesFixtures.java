...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getTextMessage(boolean isMe) {
        return getTextMessage(getRandomMessage(), isMe);
    }

    public static Message getTextMessage(String text, boolean isMe) {
        return new Message(getRandomId(), getUser(isMe), text);
    }
    ...
    public static Message getTextMessage(String text) {
        return new Message(getRandomId(), getUser(false), text);
    }



    public static ArrayList<Message> getMessages(Date startDate, boolean isMe) {
    ...
    private static User getUser(boolean even) {
